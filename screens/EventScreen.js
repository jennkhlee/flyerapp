         ...
         <ScrollView style={styles.container}>
            ...
            <View>
                ...
                <View style={{position: 'absolute', marginLeft:20, marginTop: 110}}>
                    ...
                    2019 Annual Doggie Carnival
                    </Text>

                    <Text style={styles.orgText}>
                    By: Greater Humane Society Savannah
                    </Text>

                    <Text style={styles.descText}>
                    It's time, once again, for the Humane Society for Greater Savannah's Annual Doggie Carnival!
                    </Text>
                </View>
